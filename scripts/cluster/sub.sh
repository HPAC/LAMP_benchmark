...
#sbatch -J CppArm -o ${LAMP_LOG_DIR}/cpp_armad.log -N 1 -n 1 --mem=5000 -t 02:00:00 --partition=ih -A aices2 -C hwx2680 --nodelist=linuxihdc072 --exclusive ${LAMP_EXPERIMENTS}/scripts/cluster/cpp_arma.sh
