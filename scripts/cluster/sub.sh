...
sbatch -J Julia  -o ${LAMP_LOG_DIR}/julia.log     -N 1 -n 1 --mem=5000 -t 02:00:00 --partition=ih -A aices2 -C hwx2680 --nodelist=linuxihdc072 --exclusive ${LAMP_EXPERIMENTS}/scripts/cluster/julia.sh
