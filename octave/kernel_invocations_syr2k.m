...
syr2k_implicit_compact_ = @() syr2k_implicit_compact(A, B, C);
syr2k_implicit_noup_ = @() syr2k_implicit_noup(A, B);

b.benchmark("syr2k_implicit", reps, syr2k_implicit_);
b.benchmark("syr2k_implicit_compact", reps, syr2k_implicit_compact_);
...
function [C, time] = syr2k_implicit_compact(A, B, C)
tic;
C += A*B'+ B*A';
time = toc;
end
